package io.mosip.pms.partner.test.service.impl;
...
import io.mosip.pms.partner.dto.RetrievePartnerDetailsWithNameResponse;
...
//	}
	...
	public void downloadPartnerAPIkeyTest() {
		...
		Mockito.when(partnerPolicyRepository.findByPartnerIdAndPolicyId(Mockito.anyString(), Mockito.anyString())).thenReturn(createPartnerPolicy());
