package io.mosip.pms.partner.test.controller;
...
import io.mosip.pms.partner.response.dto.PartnersRetrieveApiKeyRequests;
...
public class PartnerServiceControllerTest {
    ...
    public void partnerSelfRegistrationTest() throws Exception {
        ...
        mockMvc.perform(post("/selfRegistration").contentType(MediaType.APPLICATION_JSON_VALUE)
    ...
    public void addContactsTest() throws Exception {
        ...
        mockMvc.perform(post("/12345/addcontact").contentType(MediaType.APPLICATION_JSON_VALUE)
    ...
    public void uploadCACertificateTest() throws Exception{
        ...
        mockMvc.perform(post("/uploadCACertificate").contentType(MediaType.APPLICATION_JSON_VALUE)
    ...
    public void uploadPartnerCertificateTest() throws Exception{
        ...
        mockMvc.perform(post("/uploadPartnerCertificate").contentType(MediaType.APPLICATION_JSON_VALUE)
    ...
    public void addBiometricExtractorsTest() throws JsonProcessingException, Exception {
    	...
    	mockMvc.perform(post("/partnerId/123456/policyId/12345").contentType(MediaType.APPLICATION_JSON_VALUE)
    ...
    public void getCredentialTypePolicyTest() throws Exception{
        ...
        mockMvc.perform(MockMvcRequestBuilders.get("/partnerId/12345/credentialType/12345")).andExpect(MockMvcResultMatchers.status().isOk());
    }
    ...
    public void mapPolicyToCredentialTypeTest() throws Exception{
        ...
        mockMvc.perform(MockMvcRequestBuilders.post("/partnerId/12345/policyId/12345/credentialType/12345")).andExpect(MockMvcResultMatchers.status().isOk());
    }
    ...
    public void getBiometricExtractorsTest() throws JsonProcessingException, Exception {
    	...
    	mockMvc.perform(MockMvcRequestBuilders.get("/partnerId/123456/policyId/12345")).andExpect(status().isOk());
    }
    ...
    public void retrievePartnerCertificateTest() throws Exception {
        ...
        mockMvc.perform(MockMvcRequestBuilders.get("/getPartnerCertificate/12345")).andExpect(MockMvcResultMatchers.status().isOk());
    }    
    ...
    public void retrievePartnerDetailsTest() throws Exception {
        ...
        mockMvc.perform(MockMvcRequestBuilders.get("/partnerId/12345")).andExpect(MockMvcResultMatchers.status().isOk());
    }
    ...
    public void updatePartnerDetailsTest() throws Exception{
    	...
    	mockMvc.perform(put("/partnerId/12345").contentType(MediaType.APPLICATION_JSON_VALUE)
    ...
    public void submitPartnerApiKeyRequestTest() throws JsonProcessingException, Exception {
    	...
    	mockMvc.perform(MockMvcRequestBuilders.patch("/12345/partnerAPIKeyRequests").contentType(MediaType.APPLICATION_JSON_VALUE)
                 .content(objectMapper.writeValueAsString(request))).andExpect(status().isOk());
    }
    ...
    public void retrieveAllApiKeyRequestsSubmittedByPartnerTillDateTest()throws Exception{
       ...
       mockMvc.perform(MockMvcRequestBuilders.get("/12345/partnerAPIKeyRequests")).andExpect(MockMvcResultMatchers.status().isOk());
    }
    ...
    public void viewApiKeyRequestStatusAndApiKey_Test() throws Exception{
        ...
        mockMvc.perform(MockMvcRequestBuilders.get("/12345/partnerAPIKeyRequests/123456")).andExpect(MockMvcResultMatchers.status().isOk());
    }
    ...
    public void searchPartnerTest() throws Exception{
        ...
        mockMvc.perform(MockMvcRequestBuilders.post("/search").contentType(MediaType.APPLICATION_JSON_VALUE)
                .content(objectMapper.writeValueAsString(request))).andExpect(status().isOk());
    }
    ...
    public void searchPartnerTypeTest() throws Exception{
        ...
        mockMvc.perform(MockMvcRequestBuilders.post("/partnerType/search").contentType(MediaType.APPLICATION_JSON_VALUE)
                .content(objectMapper.writeValueAsString(request))).andExpect(status().isOk());
    }
    ...
    public void searchApikeyRequestTest() throws Exception{
    	RequestWrapper<SearchDto> request = createSearchPartnerTypeRequest();
        mockMvc.perform(MockMvcRequestBuilders.post("/apikeyRequest/search").contentType(MediaType.APPLICATION_JSON_VALUE)
                .content(objectMapper.writeValueAsString(request))).andExpect(status().isOk());
    }
    ...
    public void searchApikeyTest() throws Exception{
    	RequestWrapper<SearchDto> request = createSearchPartnerTypeRequest();
        mockMvc.perform(MockMvcRequestBuilders.post("/apikey/search").contentType(MediaType.APPLICATION_JSON_VALUE)
                .content(objectMapper.writeValueAsString(request))).andExpect(status().isOk());
    }
    ...
    public void filterValuesTest() throws Exception{
        ...
        mockMvc.perform(MockMvcRequestBuilders.post("/filtervalues").contentType(MediaType.APPLICATION_JSON_VALUE)
                .content(objectMapper.writeValueAsString(request))).andExpect(status().isOk());
    }
    ...
    public void apikeyRequetsFilterValuesTest() throws Exception{
    	RequestWrapper<FilterValueDto> request = createFilterRequest();
        mockMvc.perform(MockMvcRequestBuilders.post("/apikeyRequest/filtervalues").contentType(MediaType.APPLICATION_JSON_VALUE)
                .content(objectMapper.writeValueAsString(request))).andExpect(status().isOk());
    }
